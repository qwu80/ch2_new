...
draw = () => {
  ...
  //  line(d2x, sliderRect.y + sliderRect.h / 2 + 10, d2x, sliderRect.y + sliderRect.h / 2 - 10);
   ...
   let stickX1 = map(115.9, 20, 800, width / 2 - 400, width / 2 + 400);
   let stickX2 = map(127.8, 20, 800, width / 2 - 400, width / 2 + 400);
    ...
    if (abs(photon.x - positive_charge.x) < 5 && photon.check) {
      if (orbital_to_show.orbital_radius == 50) {
        // if (abs(photon.wavelength - d1l) < 2) {
          if (photon.wavelength >= 115.9 && photon.wavelength <= 127.8){
        ...
        } else if (abs(photon.wavelength - d3l) < 2) {
      ...
      } else if (orbital_to_show.orbital_radius == 200 && abs(photon.wavelength - 672) < 2) {
        orbital_to_show.orbital_radius = 450;
        photon = {
          x: 0,
          y: height / 2,
